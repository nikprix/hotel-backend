...
public class ReservationsResource extends ResourceConfig {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Path("/update")
    public Response editReservation(final Reservation reservation) throws SQLException, URISyntaxException {
        ...
        if (reservationStatus != 1) {
            return Response.status(400).entity("An error occured while adding reservation. Please try again").build();
        }
